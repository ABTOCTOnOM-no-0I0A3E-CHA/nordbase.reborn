  ...
  .values([
    {
      ...
      meta: [
        ...
        { label: 'Душ и туалет', value: 'на территории, в отдельном здании' },
        { label: 'Вода в доме', value: 'холодная' },
        { label: 'Кухня', value: 'оборудована' },
        { label: 'Заезд', value: 'с 15:00, выезд до 12:00' },
      ],
      body: [
        {
          type: 'text',
          ...
          title: 'О доме',
          subtitle: '',
          body: 'Эко-дом со всеми удобствами: оборудованная кухня и холодная вода; душ и туалет — на территории, в отдельном здании, спальные места на двух этажах.\n\nИз окон — вид на тундру и море. Дом сдаётся компанией от 5 человек.',
        },
        {
          type: 'gallery',
          eyebrow: '',
    ...
    },
    {
      slug: 'dom-2',
      title: 'Дом 2',
      summary: 'Дом на 4 гостей с просторной гостиной, от 2 человек.',
      capacity: 4,
      minGuests: 2,
      kind: 'house',
      pricePerNight: 6000,
      ...
      body: [
        {
          ...
          title: 'О доме',
          subtitle: '',
          body: 'Дом с просторной гостиной и оборудованной кухней, холодная вода в доме. Душ и туалет — на территории, в отдельном здании. Рассчитан на 4 гостей, сдаётся от 2 человек.',
        },
        {
          type: 'gallery',
          eyebrow: '',
    ...
    },
    {
      slug: 'dom-3',
      title: 'Дом 3',
      summary: 'Небольшой дом на 2 гостей.',
      capacity: 2,
      minGuests: 1,
      kind: 'house',
      pricePerNight: 6000,
    ...
    /* Четыре кемпа на двоих. Отдельный вид размещения: своя цена и свои
       условия — генератор, отсутствие связи, отопление ветродуйкой. */
    ...[1, 2, 3, 4].map((n) => ({
      slug: `kemp-${n}`,
      title: `Кемп ${n}`,
      summary: 'Кемп на 2 гостей: вода, бельё, кухонный инвентарь, отопление ветродуйкой.',
      capacity: 2,
      minGuests: 1,
      kind: 'camp' as const,
      pricePerNight: 5000,
      ...
      meta: [
        { label: 'Мест', value: '2' },
        { label: 'Душ и туалет', value: 'на территории, в отдельном здании' },
        { label: 'Вода', value: 'проведена в кемп, холодная' },
        { label: 'Свет', value: 'от генератора с 8:00 до 00:00' },
        { label: 'Связь', value: 'Wi-Fi и мобильной сети нет' },
        { label: 'Отопление', value: 'ветродуйка' },
        { label: 'Заезд', value: 'с 15:00, выезд до 12:00' },
      ],
      body: [
        {
          ...
          title: 'Что внутри',
          subtitle: '',
          body: 'Кемп рассчитан на двоих: спальные места с бельём, кухонный инвентарь, вода. Отапливается ветродуйкой, свет от генератора с 8:00 до 00:00. Душ и туалет — на территории базы, в отдельном здании. Полотенца и тапки не выдаём, по наличию можно купить на базе. С животными — по договорённости.',
        },
      ],
    })),
  ])
...
await db.insert(s.faq).values(
  [
    ...
    [
      'Где находится база отдыха «Север» на полуострове Рыбачий?',
      'База стоит на полуострове Рыбачий в Мурманской области, недалеко от берега Баренцева моря. Это погранзона: пропуск мы оформляем сами, от вас нужен только паспорт.',
    ],
    [
      'Как добраться до турбазы на Рыбачьем?',
      'Обычная машина на Рыбачий не проедет. Мы встречаем гостей в Титовке и забрасываем на базу на вездеходе — заброс входит в стоимость тура. Из Мурманска до Титовки около двух часов по трассе.',
    ],
    [
...
await db.insert(s.pages).values([
  {
    slug: '',
    title: 'Главная',
    seoTitle: 'База отдыха «Север» на полуострове Рыбачий',
    seoDescription:
      'Турбаза на Рыбачьем: эко-дома со всеми удобствами, баня, питание и заброска на вездеходе от Титовки. Туры по Териберке круглый год. Свободные даты видно на сайте.',
    status: 'published',
    publishedAt: new Date(),
    body: [
      {
        type: 'hero',
        /* Заголовок — под то, как это место ищут: «база отдыха Рыбачий».
           Прежняя фраза про магию не выброшена, а перенесена в подводку:
           заголовок работает на поиск, подводка — на человека. */
        ...heading(
          'Полуостров Рыбачий · Мурманская область',
          'База отдыха «Север» на полуострове Рыбачий',
        ),
        lead: 'Погрузитесь в магию Кольского полуострова: три эко-дома со всеми удобствами, баня и питание. Заброс на вездеходе входит в стоимость тура, пропуск в погранзону оформляем сами — от вас только паспорт.',
        mediaId: heroMain,
        aurora: true,
  ...
  },
  {
    slug: 'rybachiy',
    title: 'Полуостров Рыбачий',
    seoTitle: 'База отдыха на полуострове Рыбачий — домики, баня, вездеход',
    seoDescription:
      'Турбаза «Север» на Рыбачьем: три дома с душем и кухней, баня по записи, питание по предзаказу. Встречаем в Титовке, пропуск в погранзону оформляем сами.',
    status: 'published',
    publishedAt: new Date(),
    body: [
      {
      ...
      { type: 'houses', ...heading('', 'Домики базы') },
      {
        ...
        columns: 4,
        items: [
          { title: 'Душ и туалет', text: 'В отдельном здании на территории', href: '' },
          { title: 'Баня', text: 'Оплата и время — на месте', href: '' },
      ...
      { type: 'gallery', ...heading('Что вокруг', 'Полуостров в фотографиях'), mediaIds: galleryIds },
      {
        ...
        ...heading(
          'Свободные даты',
          'Когда свободны домики на Рыбачьем',
          'Занятые числа отмечены. Выберите свободные и оставьте заявку — забронируем.',
        ),
        visible: true,
        months: 3,
      },
